    ...
    Private Sub llenarReporte()
        Select Case Me.pTipoReporte
            Case ClsEnumerados.ETipoReporte.Reporte_Sanciones
                Try
                    Me.ReportViewer1.ServerReport.ReportServerUrl = New System.Uri("http://deacelnet02/reportserver")
                    Me.ReportViewer1.ServerReport.ReportPath = "/TorneoDeacero/Reports/04 Estadistica de Sanciones" 'Expandido"
            ...
            Case ClsEnumerados.ETipoReporte.Reporte_Calendario
                Try
                    Me.ReportViewer1.ServerReport.ReportServerUrl = New System.Uri("http://deacelnet02/reportserver")
                    Me.ReportViewer1.ServerReport.ReportPath = "/TorneoDeacero/Reports/03 Calendario de partidos por jornada"
                    Dim parametros As New List(Of ReportParameter)
                    'parametros.Add(New ReportParameter("Torneo", pNombreTorneo))
                    parametros.Add(New ReportParameter("IdTorneo", Convert.ToString(pIdTorneo)))
            ...
            Case ClsEnumerados.ETipoReporte.Reporte_Cedula
                Try
                    Me.ReportViewer1.ServerReport.ReportServerUrl = New System.Uri("http://deacelnet02/reportserver")
                    Me.ReportViewer1.ServerReport.ReportPath = "/TorneoDeacero/Reports/06 CedulaArbitral"
            ...
            Case ClsEnumerados.ETipoReporte.Reporte_EstadisticasJornada
                Try                    
                    Me.ReportViewer1.ServerReport.ReportServerUrl = New System.Uri("http://deacelnet02/reportserver")
                    Me.ReportViewer1.ServerReport.ReportPath = "/TorneoDeacero/Reports/01 Tabla general"
                    Dim parametros As New List(Of ReportParameter)
                    parametros.Add(New ReportParameter("pnIdTorneo", Convert.ToInt32(8)))
                    parametros.Add(New ReportParameter("pnidJornada", Convert.ToInt32(0)))
                    ReportViewer1.ServerReport.SetParameters(parametros)
                    Me.ReportViewer1.RefreshReport()
                Catch ex As Exception
                    MsgBox("Error al cargar el reporte")
            ...
            Case ClsEnumerados.ETipoReporte.Reporte_Reglamento
                Try
                    Me.ReportViewer1.ServerReport.ReportServerUrl = New System.Uri("http://deacelnet02/reportserver")
                    Me.ReportViewer1.ServerReport.ReportPath = "/TorneoDeacero/Reports/08 Reglamento"
                    Dim parametros As New List(Of ReportParameter)
                    Me.ReportViewer1.RefreshReport()
                Catch ex As Exception
                    MsgBox("Error al cargar el reporte")
            ...
            Case ClsEnumerados.ETipoReporte.Reporte_Credenciales
                Try
                    Me.ReportViewer1.ServerReport.ReportServerUrl = New System.Uri("http://deacelnet02/reportserver")
                    Me.ReportViewer1.ServerReport.ReportPath = "/TorneoDeacero/Reports/05 Credenciales"
