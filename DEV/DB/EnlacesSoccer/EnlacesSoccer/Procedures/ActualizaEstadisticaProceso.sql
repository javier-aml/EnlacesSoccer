CREATE PROCEDURE dbo.ActualizaEstadisticaProceso
(
@IdTorneo TINYINT,
@IdJornada TINYINT,
@IdEquipo TINYINT
...
AS
	...
	SELECT @Puntos = (@PartidosGanados * 3) + (@PartidosEmpatados * 2) + (@PartidosPerdidos * 1)
	...
	BEGIN TRANSACTION
		...
		INSERT INTO dbo.TorneoEquipo (  IdTorneo,
										IdEquipo,
										IdJornada,
										PartidosJugados,
										PartidosGanados,
